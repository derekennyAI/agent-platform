...
SHARED_ENV_VARS = {
    ...
    "CLAUDE_CODE_OAUTH_TOKEN": "YOUR_ANTHROPIC_API_KEY",
    "HOME": str(HOME),
...
export PATH="/opt/homebrew/bin:/Users/YOUR_MAC_USERNAME/.local/bin:/usr/local/bin:/usr/bin:/bin"
...
$TMUX new-session -d -s "$SESSION" -c "/Users/YOUR_MAC_USERNAME/{name}" \\
    "TELEGRAM_STATE_DIR={channel_dir} $CLAUDE --settings /Users/YOUR_MAC_USERNAME/{name}/settings.json --channels plugin:telegram@claude-plugins-official"
