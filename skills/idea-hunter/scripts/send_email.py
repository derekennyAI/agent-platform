...
Usage:
    python3 send_email.py --to "YOUR_ADMIN_EMAIL" --subject "Daily Idea Digest" --body "markdown or plain text here"
    python3 send_email.py --to "YOUR_ADMIN_EMAIL" --subject "Test" --body-file /tmp/digest.md
    echo "email body" | python3 send_email.py --to "YOUR_ADMIN_EMAIL" --subject "Test" --stdin
